...
predPost <- runif(length(alpha_low),alpha_low,alpha_high)
...
predPost_1 <- runif(length(beta_low),beta_low[1,],beta_high[1,])
predPost_2 <- runif(length(beta_low),beta_low[2,],beta_high[2,])
plot(density(predPost_1), xlim=c(min(predPost_1),max(predPost_1)), lwd=2, col="darkgoldenrod3",
     main=expression(paste(beta,"- Inferred Parent")), cex.main=1.2)
lines(density(predPost_2), col=2, lwd=1.5)
...
predPost_1 <- runif(length(tau_high),tau_low[1,],tau_high[1,])
predPost_2 <- runif(length(tau_high),tau_low[2,],tau_high[2,])
plot(density(predPost_1), xlim=c(min(predPost_1),max(predPost_1)), lwd=2, col="darkgoldenrod3",
     main=expression(paste(tau,"- Inferred Parent")), cex.main=1.2)
lines(density(predPost_2), col=2, lwd=1.5)
...
predPost_1 <- rnorm(length(nu1),mean(nu1),mean(eta))
predPost_2 <- rnorm(length(nu2),mean(nu2),mean(eta))
plot(density(predPost_1), xlim=c(min(predPost_1),max(predPost_1)), lwd=2, col="darkgoldenrod3",
     main=expression(paste(mu,"- Inferred Parent")), cex.main=1.2)
lines(density(predPost_2), col=2, lwd=1.5)

plot(density(mu1), xlim=c(min(mu1),max(mu1)), lwd=2, col="darkgoldenrod1",
     main=expression(paste(mu,"- Posterior samples")), cex.main=1.2)
